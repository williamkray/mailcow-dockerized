...
<form class="form-horizontal" role="form" method="post" autocomplete="off">
	...
	<div class="passFields">
		<div class="form-group">
			...
			<div class="col-sm-5">
			<input type="password" class="form-control" pattern="(?=.*\w{6,}" name="user_new_pass" id="user_new_pass" autocomplete="off" disabled="disabled">
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-sm-3" for="user_new_pass2"><?=$lang['user']['new_password_repeat'];?></label>
			<div class="col-sm-5">
			<input type="password" class="form-control" pattern="(?=.*\w{6,}" name="user_new_pass2" id="user_new_pass2" disabled="disabled" autocomplete="off">
